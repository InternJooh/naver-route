...
import { CafeChat } from "../pages/cafe/content/CafeChat";
...
import { CafeUpdate } from "../pages/cafe/content/CafeUpdate";
import { ComicBestChallenge } from "../pages/comic/content/ComicBestChallenge";
import { ComicChallenge } from "../pages/comic/content/ComicChallenge";
import { ComicHome } from "../pages/comic/content/ComicHome";
import { ComicMyPage } from "../pages/comic/content/ComicMyPage";
import { ComicWebtoon } from "../pages/comic/content/ComicWebtoon";
...
import { MapBus } from "../pages/map/content/MapBus";
import { MapDirections } from "../pages/map/content/MapDirections";
import { MapHome } from "../pages/map/content/MapHome";
import { MapMore } from "../pages/map/content/MapMore";
import { MapSave } from "../pages/map/content/MapSave";
import { MapSubway } from "../pages/map/content/MapSubway";
import { MapTrain } from "../pages/map/content/MapTrain";
import { NewsEntertainHome } from "../pages/news/pages/newsEntertain/content/NewsEntertainHome";
import { NewsEntertainMovie } from "../pages/news/pages/newsEntertain/content/NewsEntertainMovie";
import { NewsEntertainPhoto } from "../pages/news/pages/newsEntertain/content/NewsEntertainPhoto";
import { NewsEntertainRanking } from "../pages/news/pages/newsEntertain/content/NewsEntertainRanking";
import { NewsEntertainRecent } from "../pages/news/pages/newsEntertain/content/NewsEntertainRecent";
import { NewsEntertainTV } from "../pages/news/pages/newsEntertain/content/NewsEntertainTV";
import { NewsAlgorithm } from "../pages/news/pages/newsHome/content/NewsAlgorithm";
import { NewsByCompany } from "../pages/news/pages/newsHome/content/NewsByCompany"
import { NewsEconomy } from "../pages/news/pages/newsHome/content/NewsEconomy"
import { NewsFactCheck } from "../pages/news/pages/newsHome/content/NewsFactCheck"
import { NewsITScience } from "../pages/news/pages/newsHome/content/NewsITScience"
import { NewsLifeCulture } from "../pages/news/pages/newsHome/content/NewsLifeCulture"
import { NewsOpinion } from "../pages/news/pages/newsHome/content/NewsOpinion"
import { NewsPaper } from "../pages/news/pages/newsHome/content/NewsPaper"
import { NewsPolitics } from "../pages/news/pages/newsHome/content/NewsPolitics"
import { NewsRanking } from "../pages/news/pages/newsHome/content/NewsRanking"
...
import { NewsWeatherMap } from "../pages/news/pages/newsWeather/content/NewsWeatherMap";
import { NewsWeatherVideo } from "../pages/news/pages/newsWeather/content/NewsWeatherVideo";
import { NewsWeatherWarning } from "../pages/news/pages/newsWeather/content/NewsWeatherWarning";
...
// 뉴스 연예
export const eNewsRoutesData:Data[] = [
  {
    path: '',
    component: <NewsEntertainHome />
  },
  {
    path: '/tv',
    component: <NewsEntertainTV />
  },
  {
    path: '/photo',
    component: <NewsEntertainPhoto />
  },
  {
    path: '/ranking',
    component: <NewsEntertainRanking />
  },
  {
    path: '/movie',
    component: <NewsEntertainMovie />
  },
  {
    path: '/recent',
...
// 뉴스 날씨
export const wNewsRoutesData:Data[] = [
  {
    path: '',
    component: <NewsWeatherHome />
  },
  {
    path: '/compare',
    component: <NewsWeatherCompare />
  },
  {
    path: '/air',
    component: <NewsWeatherAir />
  },
  {
    path: '/map',
    component: <NewsWeatherMap />
  },
  {
    path: '/video',
    component: <NewsWeatherVideo />
  },
  {
    path: '/warning',
    component: <NewsWeatherWarning />
  }
]
...
// 지도
export const mapRoutesData:Data[] = [
  {
    path: '',
    component: <MapHome />
  },
...
// 웹툰
export const comicRoutesData:Data[] = [
  {
    path: '',
    component: <ComicHome />
  },
  {
    path: '/webtoon',
    component: <ComicWebtoon />
  },
  {
    path: '/best-challenge',
    component: <ComicBestChallenge />
  },
  {
    path: '/challenge',
    component: <ComicChallenge />
  },
  {
    path: '/my-page',
    component: <ComicMyPage />
  }
]